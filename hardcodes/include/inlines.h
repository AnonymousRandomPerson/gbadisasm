...
static inline void inline_ov61_0222C3B0_sub_1 (UnkStruct_ov61_0222C3B0 * param0)
{
    ...
    for (v0 = 0; v0 < (4) - 1; v0++) {
        ...
        v5 = 0;
        do {
            GF_ASSERT(v1 < (((16 << 8) / (0x0300) + 2) * (4 - 1)));
            for (v4 = (1); v4 < (1) + (15); v4++) {
    ...
    DC_FlushRange(param0->unk_88, (((16 << 8) / (0x0300) + 2) * (4 - 1)) * 16 * sizeof(u16));
}
...
static inline void inline_ov61_0222C3B0_sub (UnkStruct_0201CD38 * param0, void * param1)
{
    ...
    if (v0->unk_32A == 0) {
        v0->unk_328++;
        if (v0->unk_328 >= (((16 << 8) / (0x0300) + 2) * (4 - 1))) {
            v0->unk_328 = (((16 << 8) / (0x0300) + 2) * (4 - 1)) - 2;
            v0->unk_32A ^= 1;
        }
    } else {
        v0->unk_328--;
...
inline u16 inline_020564D0 (const u16 param0)
{
    ...
    if (param0 <= 1) {
        ...
        GF_ASSERT((v1 < param0) && "ERROR:Random Calc Error!");
        return v1;
    }
}
