...
typedef enum {
    DWC_LOBBY_CHANNEL_STATE_NONE,
    DWC_LOBBY_CHANNEL_STATE_LOGINWAIT,
    DWC_LOBBY_CHANNEL_STATE_CONNECT,
    DWC_LOBBY_CHANNEL_STATE_LOGOUTWAIT,
    DWC_LOBBY_CHANNEL_STATE_ERROR
} DWC_LOBBY_CHANNEL_STATE;

typedef enum {
    DWC_LOBBY_ROOMDATA_LOCKTIME,
    DWC_LOBBY_ROOMDATA_RANDOM,
    DWC_LOBBY_ROOMDATA_ROOMTYPE,
    DWC_LOBBY_ROOMDATA_SEASON,
    DWC_LOBBY_ROOMDATA_ARCEUS,
    DWC_LOBBY_ROOMDATA_CLOSETIME,
    DWC_LOBBY_ROOMDATA_FIRESTART,
    DWC_LOBBY_ROOMDATA_FIREEND,
    DWC_LOBBY_ROOMDATA_MAX,
} DWC_LOBBY_ROOMDATA_TYPE;

typedef enum {
    DWC_LOBBY_SUBCHAN_FOOT1,
    DWC_LOBBY_SUBCHAN_FOOT2,
    DWC_LOBBY_SUBCHAN_CLOCK,
    DWC_LOBBY_SUBCHAN_NEWS,
    DWC_LOBBY_SUBCHAN_NONE,
} DWC_LOBBY_SUBCHAN_TYPE;

typedef enum {
    DWC_LOBBY_SUBCHAN_LOGIN_WAIT,
    DWC_LOBBY_SUBCHAN_LOGIN_OK,
    DWC_LOBBY_SUBCHAN_LOGIN_NG,
} DWC_LOBBY_SUBCHAN_LOGIN_RESULT;

typedef enum {
    DWC_LOBBY_MG_BALLSLOW,
    DWC_LOBBY_MG_BALANCEBALL,
    DWC_LOBBY_MG_BALLOON,
    DWC_LOBBY_MG_NUM,
} DWC_LOBBY_MG_TYPE;

typedef enum {
    DWC_LOBBY_MG_ENTRYNONE,
    DWC_LOBBY_MG_ENTRYWAIT,
    DWC_LOBBY_MG_ENTRYOK,
    DWC_LOBBY_MG_ENTRYNG,
} DWC_LOBBY_MG_ENTRYRET;

typedef enum {
    DWC_LOBBY_ANKETO_STATE_NONE,
    DWC_LOBBY_ANKETO_STATE_SENDING,
    DWC_LOBBY_ANKETO_STATE_SENDOK,
    DWC_LOBBY_ANKETO_STATE_SENDNG,
} DWC_LOBBY_ANKETO_STATE;

typedef enum {
    DWC_LOBBY_ANKETO_DATA_NOW_QUESTION_SERIAL,
    DWC_LOBBY_ANKETO_DATA_NOW_QUESTION_NO,
    DWC_LOBBY_ANKETO_DATA_NOW_QUESTION_SPECIAL,
    DWC_LOBBY_ANKETO_DATA_NOW_QUESTION_NINI,
    DWC_LOBBY_ANKETO_DATA_LAST_QUESTION_SERIAL,
    DWC_LOBBY_ANKETO_DATA_LAST_QUESTION_NO,
    DWC_LOBBY_ANKETO_DATA_LAST_QUESTION_SPECIAL,
    DWC_LOBBY_ANKETO_DATA_LAST_QUESTION_NINI,
    DWC_LOBBY_ANKETO_DATA_LAST_RESULT_A,
    DWC_LOBBY_ANKETO_DATA_LAST_RESULT_B,
    DWC_LOBBY_ANKETO_DATA_LAST_RESULT_C,
    DWC_LOBBY_ANKETO_DATA_MAX,
} DWC_LOBBY_ANKETO_DATA;

typedef enum {
    DWC_LOBBY_ANKETO_MESSAGE_NOW_QUESTION,
    DWC_LOBBY_ANKETO_MESSAGE_NOW_ANSWER_00,
    DWC_LOBBY_ANKETO_MESSAGE_NOW_ANSWER_01,
    DWC_LOBBY_ANKETO_MESSAGE_NOW_ANSWER_02,
    DWC_LOBBY_ANKETO_MESSAGE_LAST_QUESTION,
    DWC_LOBBY_ANKETO_MESSAGE_LAST_ANSWER_00,
    DWC_LOBBY_ANKETO_MESSAGE_LAST_ANSWER_01,
    DWC_LOBBY_ANKETO_MESSAGE_LAST_ANSWER_02,
    DWC_LOBBY_ANKETO_MESSAGE_MAX,
