#ifndef POKEPLATINUM_SPL_RESOURCE_H
...
typedef struct SPLResource_t {
    ...
    SPLResChld * p_chld;
    UnkStruct_020147B8 * fld_ary;
    u16 fld_num;
    u16 reserved;
} SPLResource;

#endif // POKEPLATINUM_SPL_RESOURCE_H
